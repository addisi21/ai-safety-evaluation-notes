...
- [data/policy_metric_set.json](data/policy_metric_set.json): public policy classification set with gold and predicted labels
- [scripts/policy_metrics.py](scripts/policy_metrics.py): dependency-free precision, recall, and F1 script
- [outputs/policy-metrics-report.md](outputs/policy-metrics-report.md): generated policy metrics report and review queue
...
python scripts/policy_metrics.py
```
# AI Safety Evaluation Notes
